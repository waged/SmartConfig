package in.purelogic.smartconfig.task;

import android.content.Context;
import android.os.Looper;
import android.text.TextUtils;
import android.util.Log;
import in.purelogic.smartconfig.esptouch.EsptouchResult;
import in.purelogic.smartconfig.esptouch.IEsptouchListener;
import in.purelogic.smartconfig.esptouch.IEsptouchResult;
import in.purelogic.smartconfig.esptouch.IEsptouchTask;
import in.purelogic.smartconfig.protocol.EsptouchGenerator;
import in.purelogic.smartconfig.udp.UDPSocketClient;
import in.purelogic.smartconfig.udp.UDPSocketServer;
import in.purelogic.smartconfig.util.ByteUtil;
import in.purelogic.smartconfig.util.EspAES;
import in.purelogic.smartconfig.util.EspNetUtil;
